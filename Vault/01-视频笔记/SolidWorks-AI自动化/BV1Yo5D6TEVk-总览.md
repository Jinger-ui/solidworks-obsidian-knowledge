...
>
> 各分 P 笔记已补充 **SolidWorks API/机械设计知识点实质内容**（约 800–1500 字/篇，2026-06-06）。B 站 API 无外挂字幕，逐字稿可后续用 Whisper/BiliNote 补充。
...
|------|-------------|------|------|------|
| P01 | P01_图纸阅读与建模思路_带字幕配音 | 25m01s | ~3720 | [[P01-图纸阅读与建模思路]] |
| P02 | P02_SolidWorks启动与自动化准备_带字幕配音 | 45m03s | ~3924 | [[P02-环境自动化准备]] |
| P03 | P03_API调试与流程确认_带字幕配音 | 30m03s | ~3675 | [[P03-API调用与参数确认]] |
| P04 | P04_基础零件建模生成_带字幕配音 | 40m04s | ~3348 | [[P04-参数化零件建模]] |
| P05 | P05_复杂零件与标准件完善_带字幕配音 | 30m02s | ~3090 | [[P05-装配体标准件生成]] |
| P06 | P06_装配尝试与保存收尾_带字幕配音 | 20m28s | ~3211 | [[P06-装配尝试与保存收尾]] |
