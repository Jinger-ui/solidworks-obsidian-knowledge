---
title: "P47 Barzilar-Borwein方法"
source: "https://www.bilibili.com/video/BV1Kc411i7kJ?p=47"
up: "Proof-Trivial"
tags: [最优化, 凸优化, 视频笔记, linesearch, 北大, 文再文, 教程级]
duration: "14m04s"
cid: 1354626165
created: 2026-06-06
updated: 2026-06-06
...
← [[BV1Kc411i7kJ-总览]] | ← [[P46-梯度下降法]] | 下一篇 → [[P48-次梯度的定义]]

## 视频信息

| 项目 | 内容 |
|------|------|
| 分集 | 8.8 Barzilar-Borwein方法 |
| 模块 | 第8章 线搜索与梯度法 |
| 时长 | 14 分 04 秒 |
| 链接 | [B 站 P47](https://www.bilibili.com/video/BV1Kc411i7kJ?p=47) |
| 教材 | 文再文《最优化：建模、算法与理论》 |
| 内容来源 | 知识点增强（教材体系，非逐字转写） |

## 核心要点

1. **本 P 主题**：Barzilar-Borwein方法
2. **模块定位**：第8章 线搜索与梯度法（P40–P47）
3. **考试/实践侧重**：BB 步长 s_k^Ty_k/y_k^Ty_k、非单调线搜索
4. **笔记层级**：教程级（约 3229 字），含速览、图解、Walkthrough、自测题
5. **学习建议**：先通读「3 分钟速览」与「图解」，再读「详细讲解」

> 以下内容基于北大文再文最优化课程体系撰写，对应 B 站分 P「8.8 Barzilar-Borwein方法」。**非 UP 逐字转写**；不看视频也可建立框架，看视频可对照「与视频对照表」深化。

## 本节在系列中的位置

**模块**：第8章 线搜索与梯度法（P40–P47）· 系列第 **P47/101** 集。
...
**Barzilar-Borwein方法** 是北大文再文最优化课程核心一讲。读完本节你应能：① 复述核心定义与定理；② 说明在 16 章知识体系中的位置；③ 完成一道典型推导或算法步骤。考试/面试侧重：**BB 步长 s_k^Ty_k/y_k^Ty_k、非单调线搜索**。

## 零基础导读

本节「Barzilar-Borwein方法」属于 **第8章 线搜索与梯度法**。文再文课程强调**建模—理论—算法**三位一体，与教材《最优化：建模、算法与理论》同步。即便未看视频，也应先建立「定义 → 定理/算法 → 收敛分析 → 与前后讲衔接」四层结构。

第一遍盯住：本讲**解决什么问题**？**关键假设**（凸性、光滑性、Lipschitz、CQ）是什么？**算法复杂度/收敛率**如何表述？第二遍对照教材例题补全证明细节。

## 详细讲解

### 1. 本讲主题：Barzilar-Borwein方法
...
线搜索像**试探步长**：先找下降方向，再决定走多远；Wolfe 条件防止步长过小或过大。
...
- ✅ **教程级增强**：含 Mermaid、Walkthrough、自测题（约 3229 字，2026-06-06）
- ⏳ 逐字转写：API 无外挂字幕轨；可选 Whisper/BiliNote 后续补充

## 关键截图

![[../../06-资源附件/video-notes-images/BV1Kc411i7kJ-P47-cover.jpg|B站首帧 P47]]
