---
title: "P26 USB拓展坞原理图设计"
source: "https://www.bilibili.com/video/BV1At421h7Ui?p=26"
up: "Expert电子实验室"
...
← [[BV1At421h7Ui-总览]] | ← [[P25-USB拓展坞元件选型]] | 下一篇 → [[P27-USB拓展坞PCB布局]]
...
| 模块 | USB拓展坞实战（P25–P29） |
| 时长 | 22 分 32 秒 |
| 链接 | [B 站 P26](https://www.bilibili.com/video/BV1At421h7Ui?p=26) |
| 课程资料 | [夸克网盘](https://pan.quark.cn/s/05650fad6466) |
| 内容来源 | 教程级知识点增强（非逐字转写） |

## 核心要点

1. **本 P 主题**：USB拓展坞原理图设计
2. **模块定位**：USB拓展坞实战（P25–P29）
3. **实操/考试侧重**：Hub 原理图、CC 电阻、模块化
4. **笔记层级**：教程级（约 3139 字），含速览、Mermaid、Walkthrough、自测题
5. **学习建议**：P13 起请安装嘉立创 EDA 专业版跟画；资料包工程与视频同步打开

> 以下内容基于 Expert电子实验室 PCB 课程体系撰写，对应 B 站分 P「【强化篇】25-USB拓展坞原理图设计」。**非 UP 逐字转写**；不看视频也可建立框架，看视频可对照「与视频对照表」深化。

## 本节在系列中的位置

**模块**：USB拓展坞实战（P25–P29）· 系列第 **P26/29** 集。
...
**USB拓展坞原理图设计** 是本课程关键一讲。读完应能：① 复述核心概念与参数；② 在嘉立创 EDA 中完成对应操作；③ 通过自测题检验。侧重：**USB2.0 Hub 拓扑、CC 电阻、差分对布线预留、电源分配、原理图模块化**。

## 零基础导读

本节「USB拓展坞原理图设计」属于 **USB拓展坞实战**。国一学长课程强调**动手跟画**，本笔记补齐文字细节与菜单路径，便于暂停视频时查阅。
...
本集归属 **USB拓展坞实战**（P25–P29），是 Expert电子实验室嘉立创 EDA 保姆级课程的第 **P26** 集。

**实践/考试侧重**：USB2.0 Hub 拓扑、CC 电阻、差分对布线预留、电源分配、原理图模块化

### 2. 核心知识框架

#### 2.1 概念定义

Hub 拓扑：上游口 ← CH334 ← 4 下游口。每下游口独立电源分配与去耦。CC 配置决定 Type-C 角色。原理图分模块：电源、Hub 核心、Type-C×N、LED 指示。
...
承接 P25 内容，USB拓展坞实战模块核心环节，为 P27 铺垫。大师篇（独立合集）将进阶高速与多层设计。
...
**本集练习**：暂停视频，在笔记「Walkthrough」节逐步打勾；完成后用文末 3 道自测题检验。**验收标准**：能独立复述「USB拓展坞原理图设计」3 个关键要点，并在 EDA 或草稿纸完成 1 项小练习。
...
- ← **USB拓展坞元件选型**（[[P25-USB拓展坞元件选型]]）
- → **USB拓展坞PCB布局**（[[P27-USB拓展坞PCB布局]]）

## 来源说明

- ✅ B 站官方元数据（`Tools/BV1At421h7Ui-full.json`）
- ✅ 分 P 首帧封面（`06-资源附件/video-notes-images/BV1At421h7Ui-P26-cover.jpg`）
- ✅ **教程级增强**：含 Mermaid、Walkthrough、自测题（约 3139 字，2026-06-06）
- ✅ 课程资料：[夸克网盘](https://pan.quark.cn/s/05650fad6466)
- ⏳ 逐字转写：待 Whisper/BiliNote

## 关键截图

![[../../06-资源附件/video-notes-images/BV1At421h7Ui-P26-cover.jpg|B站首帧 P26]]
