---
title: "P27 USB拓展坞PCB布局"
source: "https://www.bilibili.com/video/BV1At421h7Ui?p=27"
up: "Expert电子实验室"
...
← [[BV1At421h7Ui-总览]] | ← [[P26-USB拓展坞原理图设计]] | 下一篇 → [[P28-USB拓展坞PCB布线]]
...
| 模块 | USB拓展坞实战（P25–P29） |
| 时长 | 14 分 06 秒 |
| 链接 | [B 站 P27](https://www.bilibili.com/video/BV1At421h7Ui?p=27) |
| 课程资料 | [夸克网盘](https://pan.quark.cn/s/05650fad6466) |
| 内容来源 | 教程级知识点增强（非逐字转写） |

## 核心要点

1. **本 P 主题**：USB拓展坞PCB布局
2. **模块定位**：USB拓展坞实战（P25–P29）
3. **实操/考试侧重**：USB 板布局、差分预留
4. **笔记层级**：教程级（约 3117 字），含速览、Mermaid、Walkthrough、自测题
5. **学习建议**：P13 起请安装嘉立创 EDA 专业版跟画；资料包工程与视频同步打开

> 以下内容基于 Expert电子实验室 PCB 课程体系撰写，对应 B 站分 P「【强化篇】26-USB拓展坞PCB布局」。**非 UP 逐字转写**；不看视频也可建立框架，看视频可对照「与视频对照表」深化。

## 本节在系列中的位置

**模块**：USB拓展坞实战（P25–P29）· 系列第 **P27/29** 集。
...
**USB拓展坞PCB布局** 是本课程关键一讲。读完应能：① 复述核心概念与参数；② 在嘉立创 EDA 中完成对应操作；③ 通过自测题检验。侧重：**USB 口靠边放置、Hub IC 居中、去耦电容环绕、差分对间距等长预留**。

## 零基础导读

本节「USB拓展坞PCB布局」属于 **USB拓展坞实战**。国一学长课程强调**动手跟画**，本笔记补齐文字细节与菜单路径，便于暂停视频时查阅。
...
本集归属 **USB拓展坞实战**（P25–P29），是 Expert电子实验室嘉立创 EDA 保姆级课程的第 **P27** 集。

**实践/考试侧重**：USB 口靠边放置、Hub IC 居中、去耦电容环绕、差分对间距等长预留

### 2. 核心知识框架

#### 2.1 概念定义

USB 板布局：Type-C 座板边，ESD 紧靠连接器，Hub IC 居中，晶振靠近 XI/XO，各端口去耦 0.1μF+10μF。差分对相邻端口注意隔离，避免串扰。
...
承接 P26 内容，USB拓展坞实战模块核心环节，为 P28 铺垫。大师篇（独立合集）将进阶高速与多层设计。
...
**本集练习**：暂停视频，在笔记「Walkthrough」节逐步打勾；完成后用文末 3 道自测题检验。**验收标准**：能独立复述「USB拓展坞PCB布局」3 个关键要点，并在 EDA 或草稿纸完成 1 项小练习。
...
- ✅ 分 P 首帧封面（`06-资源附件/video-notes-images/BV1At421h7Ui-P27-cover.jpg`）
- ✅ **教程级增强**：含 Mermaid、Walkthrough、自测题（约 3117 字，2026-06-06）
- ✅ 课程资料：[夸克网盘](https://pan.quark.cn/s/05650fad6466)
- ⏳ 逐字转写：待 Whisper/BiliNote

## 关键截图

![[../../06-资源附件/video-notes-images/BV1At421h7Ui-P27-cover.jpg|B站首帧 P27]]
