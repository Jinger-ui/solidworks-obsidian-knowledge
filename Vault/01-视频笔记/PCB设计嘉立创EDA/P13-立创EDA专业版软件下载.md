---
title: "P13 立创EDA专业版软件下载"
source: "https://www.bilibili.com/video/BV1At421h7Ui?p=13"
up: "Expert电子实验室"
...
← [[BV1At421h7Ui-总览]] | ← [[P12-PCB设计基础-PCB设计流程]] | 下一篇 → [[P14-熟悉软件操作界面]]
...
| 模块 | 嘉立创EDA操作（P13–P17） |
| 时长 | 2 分 42 秒 |
| 链接 | [B 站 P13](https://www.bilibili.com/video/BV1At421h7Ui?p=13) |
| 课程资料 | [夸克网盘](https://pan.quark.cn/s/05650fad6466) |
| 内容来源 | 教程级知识点增强（非逐字转写） |

## 核心要点

1. **本 P 主题**：立创EDA专业版软件下载
2. **模块定位**：嘉立创EDA操作（P13–P17）
3. **实操/考试侧重**：lceda.cn 下载安装、专业版特性
4. **笔记层级**：教程级（约 2974 字），含速览、Mermaid、Walkthrough、自测题
5. **学习建议**：P13 起请安装嘉立创 EDA 专业版跟画；资料包工程与视频同步打开

> 以下内容基于 Expert电子实验室 PCB 课程体系撰写，对应 B 站分 P「【强化篇】12-立创EDA专业版软件下载」。**非 UP 逐字转写**；不看视频也可建立框架，看视频可对照「与视频对照表」深化。

## 本节在系列中的位置

**模块**：嘉立创EDA操作（P13–P17）· 系列第 **P13/29** 集。
...
**立创EDA专业版软件下载** 是本课程关键一讲。读完应能：① 复述核心概念与参数；② 在嘉立创 EDA 中完成对应操作；③ 通过自测题检验。侧重：**lceda.cn 下载、专业版 vs 标准版、账号与工程云同步**。

## 零基础导读

本节「立创EDA专业版软件下载」属于 **嘉立创EDA操作**。国一学长课程强调**动手跟画**，本笔记补齐文字细节与菜单路径，便于暂停视频时查阅。
...
本集归属 **嘉立创EDA操作**（P13–P17），是 Expert电子实验室嘉立创 EDA 保姆级课程的第 **P13** 集。

**实践/考试侧重**：lceda.cn 下载、专业版 vs 标准版、账号与工程云同步

### 2. 核心知识框架

#### 2.1 概念定义

嘉立创 EDA 专业版从 lceda.cn 下载，需注册账号。支持 Windows/macOS/Linux。工程文件云端同步，可团队协作。与标准版相比，专业版支持更复杂设计规则、3D 预览、更多层数。
...
承接 P12 内容，嘉立创EDA操作模块核心环节，为 P14 铺垫。大师篇（独立合集）将进阶高速与多层设计。
...
**本集练习**：暂停视频，在笔记「Walkthrough」节逐步打勾；完成后用文末 3 道自测题检验。**验收标准**：能独立复述「立创EDA专业版软件下载」3 个关键要点，并在 EDA 或草稿纸完成 1 项小练习。
...
- → **熟悉软件操作界面**（[[P14-熟悉软件操作界面]]）

## 来源说明

- ✅ B 站官方元数据（`Tools/BV1At421h7Ui-full.json`）
- ✅ 分 P 首帧封面（`06-资源附件/video-notes-images/BV1At421h7Ui-P13-cover.jpg`）
- ✅ **教程级增强**：含 Mermaid、Walkthrough、自测题（约 2974 字，2026-06-06）
- ✅ 课程资料：[夸克网盘](https://pan.quark.cn/s/05650fad6466)
- ⏳ 逐字转写：待 Whisper/BiliNote

## 关键截图

![[../../06-资源附件/video-notes-images/BV1At421h7Ui-P13-cover.jpg|B站首帧 P13]]
